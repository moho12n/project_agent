...
public class SequentialPrintBehaviourAgent extends DefaultAgent {
    ...
    protected void setup() {
        ...
        SequentialBehaviour myCompositeBehaviour = new SequentialBehaviour(this){   // Classe anonyme pour spécifier le onEnd().
